...
namespace SimpleTagProcessor.Data
{
    public class TagProcessorFactory : ITagProcessorFactory
    {
        ...
        public IBatchTagProcessor GetBatchTagProcessor(TagType tagType, string fileName)
        {
            IBatchTagProcessor tagProcessor;
            ...
            switch (tagType)
            {
                ...
                case TagType.SGTIN_96:
                    tagProcessor = new TagProcessor(new TextFileTagRepository(fileName), new SGTIN96STagHexStringValidator(), new SGTIN96TagFieldsConstructor());
                    break;
